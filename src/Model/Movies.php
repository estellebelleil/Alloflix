...
class Movies
{
    ...
    {
        // Avec securité en plus
        // Si $id est entre 0 et 3
        // if ($id >= 0 && $id < count(self::$movies)){ 
        //     return self::$movies[$id]; 
        // }
        
        // Plus simple
        // On retourne le film qui a pour index => $id
        // Si $id = 0 => alors on retourne $movies[0] (Donc A bug's life)
        return self::$movies[$id]; 
    }
}